...
void parse_identifiers(t_data *data)
{
	...
	j = 0;
	i = 0;
	while (data->map_tab[i] && enough_identifiers(data) == false) // Penser a rajouter les \t et \r
	{
		j = 0;
